...
class TestModel:
    ...
    def test_best(self, quote_nuber, expected):
        with open("tests/exam/bashorg_parser/best.html", "r") as file:
    ...
    def test_last(self, quote_nuber, expected):
        with open("tests/exam/bashorg_parser/last.html", "r") as file:
    ...
    def test_random(self, quote_nuber, expected):
        with open("tests/exam/bashorg_parser/random.html", "r") as file:
            assert parse("".join(file.readlines()), quote_nuber) == expected
