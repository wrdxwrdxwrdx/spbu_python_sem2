...
class AddToStart(Action):
    ...
    def action(self, object_collection: MutableSequence[float]) -> MutableSequence[float]:
        object_collection.insert(0, self.number)
        return object_collection

    def inverse_action(self, object_collection: MutableSequence[float]) -> MutableSequence[float]:
...
class DeleteFromStart(Action):
    ...
    def __init__(self) -> None:
        self.deleted_obj: Optional[float] = None
...
class DeleteFromEnd(Action):
    ...
    def __init__(self) -> None:
        self.deleted_number: Optional[float] = None
...
class AddToSet(Action):
    ...
    def action(self, object_collection: Set[float]) -> Set[float]:
    ...
    def inverse_action(self, object_collection: Set[float]) -> Set[float]:
        if len(object_collection) > 0:
...
class SortAscending(Action):
    ...
    def __init__(self) -> None:
        self.unsorted_collection: Optional[MutableSequence[float]] = None

    @staticmethod
    def bubble_ascending(collection: MutableSequence[float]) -> MutableSequence[float]:
...
class SortDescending(Action):
    ...
    @staticmethod
    def bubble_descending(collection: MutableSequence[float]) -> MutableSequence[float]:
        for i in range(0, len(collection) - 1):
            for j in range(0, len(collection) - 1 - i):
                if collection[j] < collection[j + 1]:
                    collection[j], collection[j + 1] = collection[j + 1], collection[j]
...
class Shuffle(Action):
    ...
    def __init__(self) -> None:
        self.unshuffled_collection: Optional[MutableSequence[float]] = None
